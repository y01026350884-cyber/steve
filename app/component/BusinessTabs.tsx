...
export default function GreetingPage() {
  ...
  return (
    <>
      ...
      {/* ===== 하단 탭바 — Business 페이지와 완전 동일한 레이아웃/사이즈 ===== */}
          ...
          <div>
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                광범위한 실적으로 다른 회사와 차별화된 <strong>레이저 임가공 전문업체</strong>입니다.
              </p>

              <p>
                저희는 초소형 부품에서 초대형 부품까지 반도체, 2차전지, 기계, 건설,
                자동차, 선박 등 다양한 산업 전반에 걸쳐 사용되는 범용 제품부터
                신소재 산업에 적용되는 <strong>고부가가치 제품 가공</strong>까지 폭넓게 대응하고 있습니다.
              </p>

              <p>
                또한 금속 레이저 임가공업의 선두에 서서 약 20여 년의 업력을 바탕으로
                모든 제품을 완벽하게 처리하며, <strong>고객 만족을 최우선</strong>으로 하는
                최고의 기업으로 성장을 목표로 하고 있습니다.
              </p>
